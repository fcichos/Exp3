...
![Deflection angle as a function of the incidence angle for different prism angles.](Optical Elements II_files/figure-pdf/fig-refractive-indices-output-1.pdf){#fig-refractive-indices fig-align='center'}
:::
:::
...
::: {.cell cold-fold='true' execution_count=3}

::: {.cell-output .cell-output-display}
![Refractive index of different glasses as a function of the wavelength.](Optical Elements II_files/figure-pdf/fig-wavelength-dependence-output-1.pdf){#fig-wavelength-dependence fig-align='center'}
:::
:::


::: {.cell cold-fold='true' execution_count=4}

::: {.cell-output .cell-output-display}
![Deflection angle as a function of the incidence angle for different wavelengths.](Optical Elements II_files/figure-pdf/fig-angle-dependence-output-1.pdf){#fig-angle-dependence}
:::
:::
...
::: {.cell cold-fold='true' execution_count=5}

::: {.cell-output .cell-output-display}
![Refractive index of water as a function of the wavelength.](Optical Elements II_files/figure-pdf/fig-water-n-output-1.pdf){#fig-water-n}
:::
:::

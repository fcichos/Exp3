...
and use the small angle approximation to get rid of the \textit{sine} function. Solving for the phase difference $\Delta \phi_{1/2}$ at half maximum, we can determine the corresponding frequency width:

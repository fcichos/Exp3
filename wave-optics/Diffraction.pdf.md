...
![Caption](Diffraction_files/figure-pdf/cell-3-output-1.pdf){}
:::
:::
...
::: {.cell-output .cell-output-display}
![Diffraction pattern of a grating where 8 slits with a width of 2 µm and a distance of 4 micrometers are illuminated by a wavelength of 532 nm.](Diffraction_files/figure-pdf/cell-4-output-1.pdf){}
:::
:::
...
::: {.cell-output .cell-output-display}
![Diffraction pattern of a grating with $N=8$ slits ($d=4$ µm, $b=1$ µm) with $\lambda=532$ nm.](Diffraction_files/figure-pdf/cell-5-output-1.pdf){}
:::
:::
...
::: {.cell-output .cell-output-display}
![Diffraction pattern of a grating with $N=100$ slits ($d=4$ µm, $b=1$ µm) with $\lambda=532$ nm.](Diffraction_files/figure-pdf/cell-6-output-1.pdf){}
:::
:::
...
::: {.cell-output .cell-output-display}
![Rayleigh resolution limit of a grating with $N=100$ slits ($d=4$ µm, $b=1$ µm) with $\lambda_1=532$ nm and $\lambda_2=537$ nm in the first order diffraction peak (left) and the second order peak (right).](Diffraction_files/figure-pdf/cell-7-output-1.pdf){}
:::
:::
